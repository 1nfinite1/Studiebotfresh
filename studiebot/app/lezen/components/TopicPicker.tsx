...
export function TopicPicker({ onTopicSelect, isGenerating }: TopicPickerProps) {
  ...
  return (
    ...
    <section
      ...
      style={{ gridTemplateColumns: 'minmax(0,1fr) 4px minmax(0,1fr)' }}
    >
      {/* Left half - Topics */}
      ...
      {/* Center divider - Gri çizgi bar */}
      <div 
        className="col-start-2 col-end-3 flex justify-center items-center"
      ...
      <div className="flex flex-col justify-center items-center p-8">
        <div className="space-y-8 w-full max-w-2xl text-center mx-auto">
          <div className="space-y-8">
            ...
            {/* Tekst genereren butonu - yukarıdaki iki kısım için ortalanmış */}
